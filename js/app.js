...
const BOUL_ZELEN = "img/boul_s_zelenyu.webp";
const BOUL_LOSOS = "img/boul_s_lasos.webp";
const BOUL_TUNA = "img/boul_s_tuntsom.webp";
...
const SALAT_BURRATA = "img/salat_burrata.webp";
const SALAT_BAKLAJAN = "img/salat_xrustashiy_baklajan.webp";
const SALAT_TROPICAL = "img/salat_tropicheskiy.webp";
const PIZZA_PEPPERONI = "img/pizza_peperoni.webp";
const SALAT_GRILL = "img/salat_grill.webp";
...
const LIMONAD_MANGO_MARAKUYA = "img/limonad_mango_marakuya.webp";
...
const MENU = {
  'breakfasts': [
    ...
    { id: 'syrniki', name: { ru: 'Сырники', uz: 'Sirniklar' }, desc: { ru: 'Нежные творожные сырники со сметаной, ягодами и шоколадным соусом', uz: 'Smetana, rezavorlar va shokoladli sous bilan mayin tvorogli sirniklar' }, weight: '', price: 45000, badge: '', img: SIRNIKI },
  ...
  'set_breakfast': [
    { id: 'set_italian', name: { ru: 'Завтрак с лососем и авокадо', uz: 'Qizil baliq va avokadoli nonushta' }, desc: { ru: 'Сет: скрэмбл, слабосолёный лосось, тост с авокадо и сливочным сыром, салат и апельсин', uz: 'Set: skrembl, tuzlangan qizil baliq, avokado va qaymoqli pishloqli tost, salat hamda apelsin' }, weight: '', price: 85000, badge: 'СЕТ', img: ITALYANSKIY_ZAVTRAK },
    { id: 'set_french', name: { ru: 'Завтрак с яйцами пашот и курицей', uz: 'Pashot tuxum va tovuqli nonushta' }, desc: { ru: 'Сет: яйца пашот, куриное филе, сыр, тосты, салат и томаты черри', uz: 'Set: pashot tuxum, tovuq filesi, pishloq, tostlar, salat va cherri pomidorlar' }, weight: '', price: 65000, badge: 'СЕТ', img: FRANCUZSKIY_ZAVTRAK },
    { id: 'set_english', name: { ru: 'Английский завтрак', uz: 'Ingliz nonushtasi' }, desc: { ru: 'Сет: яичница, сосиски, грибы, томаты, картофельные дольки и тосты', uz: 'Set: qovurilgan tuxum, sosiskalar, qo‘ziqorinlar, pomidorlar, kartoshka bo‘laklari va tostlar' }, weight: '', price: 55000, badge: 'СЕТ', img: ANGLIYSKIY_ZAVTRAK }
  ],
  'salads': [
    { id: 'salad_burrata', name: { ru: 'Салат Буррата', uz: 'Burrata salati' }, desc: { ru: 'Нежная буррата со сладкими томатами, зеленью и бальзамическим соусом', uz: 'Shirin pomidorlar, ko‘katlar va balzamik sous bilan mayin burrata' }, weight: '', price: 85000, badge: '', img: SALAT_BURRATA },
    ...
    { id: 'salad_roastbeef', name: { ru: 'Салат Ростбиф', uz: 'Rostbif salati' }, desc: { ru: 'Сочные ломтики ростбифа с рукколой, черри и выдержанным пармезаном', uz: "Rukkola, cherri va parmezan bilan suvli rostbif bo'laklari" }, weight: '', price: 85000, badge: '', img: SALAT_ROSTBIF },
    ...
    { id: 'salad_tropical', name: { ru: 'Салат с курицей и цитрусами', uz: 'Tovuq va sitrusli salat' }, desc: { ru: 'Куриное филе, свежая зелень, огурцы, цитрусы и грецкие орехи', uz: 'Tovuq filesi, yangi ko‘katlar, bodring, sitruslar va yong‘oq' }, weight: '', price: 45000, badge: '', img: SALAT_TROPICAL },
    { id: 'salad_eggplant', name: { ru: 'Салат Хрустящий баклажан', uz: 'Qarsildoq baqlajon salati' }, desc: { ru: 'Хрустящие баклажаны в сладком чили с томатами черри, кинзой и кунжутом', uz: 'Shirin chili sousidagi qarsildoq baqlajon, cherri pomidor va kunjut' }, weight: '', price: 60000, badge: '', img: SALAT_BAKLAJAN },
    { id: 'salad_caesar', name: { ru: 'Салат Цезарь', uz: 'Sezar salati' }, desc: { ru: 'Хрустящий романо, обжаренное филе курицы, гренки, пармезан и соус цезарь', uz: 'Qarsildoq romano, tovuq filesi, suxariklar, parmezan va sezar sousi' }, weight: '', price: 60000, badge: 'HIT', img: SALAT_CAESAR }
  ],
  'sandwiches': [
  ...
  'mains': [
    ...
    { id: 'bone_steak', name: { ru: 'Стейк с картофелем', uz: 'Kartoshkali steyk' }, desc: { ru: 'Сочный стейк с картофелем-гармошкой и соусом', uz: 'Kartoshka-garmoshka va sous bilan suvli steyk' }, weight: '', price: 150000, badge: 'HIT', img: BONESTEYK_PAYE },
  ...
  'pizza': [
    { id: 'pizza_al_polo', name: { ru: 'Пицца Аль Поло', uz: 'Al Polo pitsa' }, desc: { ru: 'Нежное куриное филе, грибы, моцарелла и сливочная основа', uz: 'Tovuq filesi, qo‘ziqorinlar, motsarella va qaymoqli asos' }, weight: '', price: 85000, badge: '', img: PIZZA_AL_POLO },
  ...
  'lemonades': [
    ...
    { id: 'smoothie_mint', name: { ru: 'Банановый смузи', uz: 'Bananli smuzi' }, desc: { ru: 'Густой смузи с бананом', uz: 'Bananli quyuq smuzi' }, weight: '', price: 45000, badge: '', img: MYATNIY_SMUZI },
  ...
  'matcha': [
    ...
    { id: 'anchan_peach', name: { ru: 'Напиток Персик-манго', uz: 'Shaftoli-mango ichimligi' }, desc: { ru: 'Слоёный холодный напиток с фруктовым пюре, молочной пеной и льдом', uz: 'Mevali pyure, sutli ko‘pik va muzli qatlamli sovuq ichimlik' }, weight: '', price: 45000, badge: '', img: ANCHAN_PERSIK_MANGO },
